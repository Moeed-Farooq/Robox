...
@objc(RoboxPerkoxOfferwallViewController)
class RoboxPerkoxOfferwallViewController: UIViewController, WKNavigationDelegate, WKUIDelegate, WKScriptMessageHandler {
  ...
  private func handleClose() {
    RoboxPerkoxModule.shared?.sendCloseEvent()
  ...
  func userContentController(_ userContentController: WKUserContentController, didReceive message: WKScriptMessage) {
    ...
    RoboxPerkoxModule.shared?.sendRewardEvent(reward)
  }
