...
@objc(RoboxPerkoxModule)
class RoboxPerkoxModule: RCTEventEmitter {
  public static var shared: RoboxPerkoxModule?
  private var hasListeners = false

  override init() {
    super.init()
    RoboxPerkoxModule.shared = self
  }
  ...
  func showOfferwall(
    ...
    DispatchQueue.main.async {
      ...
      let controller = RoboxPerkoxOfferwallViewController(
        appId: appId,
        sdkKey: sdkKey,
        playerId: playerId,
        beta: beta
